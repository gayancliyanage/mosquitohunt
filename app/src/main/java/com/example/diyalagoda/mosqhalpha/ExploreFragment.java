 ...
 */
public class ExploreFragment extends SupportMapFragment implements GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener,
        GoogleMap.OnInfoWindowClickListener,
        GoogleMap.OnMapLongClickListener,
        GoogleMap.OnMapClickListener,
        GoogleMap.OnMarkerClickListener{ private GoogleApiClient mGoogleApiClient;
...
private int curMapTypeIndex = 0;
        ...
        private void drawCircle( LatLng location ) {
            ...
            options.strokeColor( getResources().getColor( R.color.colorPrimary ) );
